...
namespace VNA_Project.BIZ
{
    public class TaiSanBiz
    {
        ...
        public static List<TaiSan> getListTaiSan()
        {
            ...
            string sql = "SELECT [MaTaiSan],[TenTaiSan] FROM  [VNAAccounting].[dbo].[TaiSan]";
        ...
        public static int AddTaiSan(TaiSan input)
        {
            ...
            sql += "VALUES(";
            sql += "N'" + input.MaTaiSan.ToUpper() + "',N'" + input.TenTaiSan + "',N'" + input.MaLoaiTaiSan.ToUpper() + "',N'" + input.MaLyDoTangGiamTaiSan.ToUpper() + "'," + input.NgayTangTaiSan + "";
            sql += "" + input.NgayTinhKhauHao + ",N'" + input.SoKyKhauHao + "',N'" + input.MaBoPhanHachToan.ToUpper() + "',N'" + input.MaPhanXuong.ToUpper() + "',N'" + input.MaPhi.ToUpper() + "'";
            ...
            sql += "N'" + input.NuocSanXuat + "',N'" + input.NamSanXuat + "'," + input.NgayDuaVaoSuDung + "," + input.NgayDinhChiSuDung + ",N'" + input.LyDoDinhChi + "',N'" + input.GhiChu + "'";
            sql += ")";
        ...
        public static int EditTaiSan(TaiSan input)
        {
            ...
            sql += "TenTaiSan = N'" + input.TenTaiSan + "',MaLoaiTaiSan = N'" + input.MaLoaiTaiSan.ToUpper() + "',MaLyDoTangGiamTaiSan = N'" + input.MaLyDoTangGiamTaiSan.ToUpper() + "',NgayTangTaiSan = " + input.NgayTangTaiSan + ",NgayTinhKhauHao = " + input.NgayTinhKhauHao + "";
            ...
            sql += "NamSanXuat = N'" + input.NamSanXuat + "',NgayDuaVaoSuDung = " + input.NgayDuaVaoSuDung + ",NgayDinhChiSuDung = " + input.NgayDinhChiSuDung + ",LyDoDinhChi = N'" + input.LyDoDinhChi + "',GhiChu = N'" + input.GhiChu + "'";
