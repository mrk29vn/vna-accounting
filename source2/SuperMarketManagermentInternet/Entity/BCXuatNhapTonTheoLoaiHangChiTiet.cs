...
{
    [Serializable]
    public class BCXuatNhapTonTheoLoaiHangChiTiet
    {
        ...
        public BCXuatNhapTonTheoLoaiHangChiTiet(string maLoaiHang, string tenLoaiHang,string maHang,string tenHang, double soDuDauKy, double nhapMua, double nhapTraLai,
